...
var incompleteTaskHolder=document.querySelector(".tasks__list--incomplete");//ul of .incomplete
var completedTasksHolder=document.querySelector(".tasks__list--completed");//completed
